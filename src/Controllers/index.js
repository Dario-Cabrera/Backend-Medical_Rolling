...
const updateDoctorById = async (req, res) => {
    try {
        const { id } = req.params;
        const { name, lastname, email, pass, specialty, LicenceNumber, isDoctor, isAuditor, appointments } = req.body;
        const updatedDoctor = await DoctorsModel.findByIdAndUpdate(id, {
            name,
            lastname,
            email,
            pass,
...
const updateAppointmentById = async (req, res) => {
    try {
        const { id } = req.params;
        const { appointmentDate, appointmentTime } = req.body;
        const updatedAppointment = await AppointmentsModel.findByIdAndUpdate(id, {
            appointmentDate,
            appointmentTime,
        }, { new: true });
        updatedAppointment ? 
...
module.exports = { postUser, postDoctor, postAppointment, getAllUsers, getAllDoctors, getAllAppointments, getUserById, getDoctorById, getAppointmentById, deleteUserById, deleteDoctorById, deleteAppointmentById, updateUserById, updateDoctorById, updateAppointmentById };